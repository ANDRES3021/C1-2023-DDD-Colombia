import { DescriptionItemValueObject } from './description.value-object';

describe('NameProductionOrderValueObject', () => {
    // Arrange and Act
    let objectValue: DescriptionItemValueObject;
    beforeEach(() => {
        objectValue =  new  DescriptionItemValueObject( 'Orden de producción 1' );
    } );
    ...
    describe('Validaciones', () => {
        test('si  le paso un valor vacio me da error', () => {
            ...
            const expected = true;
            // Act
            const objectValue =  new  DescriptionItemValueObject(name);
