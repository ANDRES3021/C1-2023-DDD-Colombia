import {  NameItemValueObject } from "./name.value-object";

describe('NameProductionOrderValueObject', () => {
    // Arrange and Act
    let objectValue: NameItemValueObject;
    beforeEach(() => {
        objectValue =  new  NameItemValueObject( 'Orden de producción 1' );
    } );
    ...
    describe('Validaciones', () => {
        test('si  le paso un valor vacio me da error', () => {
            ...
            const expected = true;
            // Act
            const objectValue =  new  NameItemValueObject(name);
